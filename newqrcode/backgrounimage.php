...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td style="font-size:20px;color:#413F42;"> '.$row['residense_type'].' </td>
		</tr>
		
		<tr>
			<td style="color:#000; font-size: 23px; font-weight: bold;"> '.$row['area'].' </td>
		</tr>
		
		<tr>
			<td style="color:#f10000; font-size: 25px; font-weight: bold;"><b> '.$row['owner_name'].' </b></td>
		</tr>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<div>&nbsp;</div>	
				<span style="font-size:20px;">Door No</span><br>
				<span style="color:#000; font-size:30px; font-weight: bold;">'.$row['door_no'].' </span>
				</td>
				<td><p></p><p></p>
					<table width="100%">
						<tr>
							<td align="center" height="238"> <img src="'.$fullpath.'" alt="qrcode" width="200"> </td>	
						</tr>
						<tr>
						
							<td align="center" style="color:#f10000; font-weight: bold; font-size: 25px;"> '.$row['assesment_no'].' </td>	
						</tr>
						<tr>
							<td>  </td>	
						</tr>
