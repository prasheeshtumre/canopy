        ...
        <div class="wrapper">
            ...
            <div class="tab-content">
                ...
                <div id="menu1" class=" tab-pane active">
                    ...
                    @endif
                    <form class="" name="verifyOTP" method="POST" action="{{ route('verifyOTP') }}"
                        autocomplete="off">
                        @csrf
                        <div class="form-field d-flex align-items-center">
                            ...
                            <input type="text" name="mobile" id="userName" placeholder="Enter Mobile Number"
                                autocomplete="off" maxlength="10" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" readonly value="{{$number}}">
                        </div>
