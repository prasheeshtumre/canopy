                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <a target="__blank" href="{{ url('admin/download-zip-codes') }}">Download Updated QR codes Zip
                                File</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.update-qr-code') }}" method="post" enctype="multipart/form-data">
                                ...
                                @if (count($users) > 0)
                                    <div>
                                        <h4 class="mb-sm-0 text-danger">Update Qr Generation is in Process. Please Wait...
                                        </h4>
                                    </div>
                                @else
