            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form action="{{url('admin/update-plan')}}/{{$Plan->plan_id}}"  method="post">
                            @csrf
                            <div class="row">
                                        ...
                                        <label for="" class="form-label">Select Client</label>
                                         <select class="form-select " name="client_id" id="client_id" >
                                             ...
                                             @foreach($clients as $client)
                                               <option @if($Plan->client_id == $client->client_id) selected @endif value="{{$client->client_id}}">{{$client->client_name}}</option>
                                             @endforeach
                                         </select>
                                          @error('client_id')
                                ...
                                <div class="col-xxl-3 col-md-2 mt-3">
                                    <div>
                                        <label for="" class="form-label">Plan Name</label>
                                          <input type="text" class="form-control" value="{{$Plan->plan_name}}" id="" name="plan_name" >
                                    </div>
                                     @error('plan_name')
                                          <span class="text-danger">{{$message}}</span>
                                      @enderror
                                ...
                                @foreach($categories as $cat)
                                     <div class="row align-items-center">      
                                        ...
                                        <div class="col-xxl-3 col-md-3 mt-3">
                                            <div>
                                               <input type="text" class="form-control" value="{{ $mapping_values[$cat->category_id] ?? ''}}" id="dob" name="category_{{$cat->category_id}}">
