    ...
    <div class="page-content">
        ...
        {{--    <div class="row">
                <div class="col-xl-12 col-md-12">
                    <h4 class="mb-sm-0">Generate Bulk QR Codes</h4>
                        ...
                        <div class="card-body">
                            <form action="" id="qr_code" name="qr_code_form" method="post">
                                ...
                                <input type="hidden" class="form-control  " id="uuid" name="uuid"
                                                required readonly value="{{$user->uuid}}">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-3 col-md-2 mt-3">
                                        <div>
                                            ...
                                            <input type="text" class="form-control  " id="plan_id" name="plan_id"
                                                required readonly value="{{$user->plan_name}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-3 col-md-4 mt-3">
                                        <div>
                                            ...
                                            <input type="date" class="form-control  " id="effective_date"
                                                name="effective_date" value="{{date('Y-m-d',strtotime($user->effective_date))}}" required>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-md-3 mt-3">
                                        <div>
                                            ...
                                            <input type="date" class="form-control filter_input" id="termination_date"
                                                name="termination_date" value="{{date('Y-m-d',strtotime($user->terminatiion_date))}}" required>
                                        </div>
                                    </div>
        ...
        $(function() {
            var table = $('.users-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'created_att', name: 'created_att' },
